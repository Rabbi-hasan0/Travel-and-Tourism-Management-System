	...
	public DeleteCustomer() throws SQLException {
		...
		contentPane.add(lb3);
                ...
                try{
                    ...
                    ResultSet rs = c.s.executeQuery("select * from customer username");
                    while(rs.next()){
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                PreparedStatement pstmt = c.c.prepareStatement(q1); // Use Connection object to prepare statement
                                pstmt.setString(1, s1);
                                int rowsAffected = pstmt.executeUpdate();
                                if (rowsAffected > 0) {
                                    JOptionPane.showMessageDialog(null, "Customer Detail Deleted Successfully");
                                    // Clear labels after deletion
                                    l2.setText("");
                                    l3.setText("");
                                    l4.setText("");
                                    l5.setText("");
                                    ...
                                    l8.setText("");
                                    l9.setText("");
                                    c1.remove(s1);       // Remove the deleted username from the choice list
                                }
...
//                    String selectedUsername = c1.getSelectedItem();
//                    String q1 = "DELETE FROM customer WHERE username = ?";
//                    PreparedStatement pstmt = c.c.prepareStatement(q1);
...
//                        l8.setText("");
//                        l9.setText("");
//                        // Remove the deleted username from the choice list
//                        c1.remove(selectedUsername);
//                    }
//                } catch (SQLException e1) {
//                    e1.printStackTrace();
//                }
